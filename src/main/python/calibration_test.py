...
# apriltag calibration code

tag_module = AprilTag()
CALIB_DIR = '' #put your path to the calibration photos here
CALIB_SQUARE_SIZE_METERS = 0.0301625
CALIB_WIDTH = 9
CALIB_HEIGHT = 9
tag_module.calibrate(CALIB_DIR, CALIB_SQUARE_SIZE_METERS, CALIB_WIDTH, CALIB_HEIGHT)
