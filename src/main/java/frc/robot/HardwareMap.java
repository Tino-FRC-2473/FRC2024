...
public final class HardwareMap {
	...
	public static final int CAN_ID_SPARK_LSHOOTER_MOTOR = 31;
	public static final int CAN_ID_SPARK_INTAKE_MOTOR = 6;
	public static final int CAN_ID_SPARK_ARM_MOTOR = 7;
	public static final int CAN_ID_SPARK_RSHOOTER_MOTOR = 32;
